        ...
        <div className="grid md:grid-cols-2 gap-8 items-center py-16 md:py-20 lg:py-28">
          <div className="order-2 md:order-1">
            ...
            <div className="animate-fade-in opacity-0 [animation-delay:0.6s] mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-blue-50 w-full sm:w-auto">
                View Past Projects
              </Button>
            </div>
          </div>
          ...
          <div className="order-1 md:order-2 flex justify-center items-center">
            <div className="relative w-full h-64 sm:h-80 md:h-96">
              {/* Animated shape 1 */}
              <div 
                className="absolute left-0 top-0 w-40 h-40 md:w-48 md:h-48 animate-float" 
                style={{ animation: 'float 7s ease-in-out infinite' }}
              >
                <img 
                  src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80&blend=4285F4&blend-alpha=10&blend-mode=normal&blend-saturation=100"
                  alt="Tech background" 
              ...
              {/* Animated shape 2 */}
              <div 
                className="absolute right-0 bottom-0 w-48 h-48 md:w-56 md:h-56 animate-float" 
                style={{ animation: 'float 6s ease-in-out infinite 0.5s' }}
              >
                <img 
                  src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80&blend=4285F4&blend-alpha=10&blend-mode=normal&blend-saturation=100"
                  alt="Student coding" 
                  className="w-full h-full object-contain rounded-lg"
                />
              </div>
              ...
              <div 
                className="absolute left-1/4 top-1/4 w-52 h-52 md:w-64 md:h-64 z-10 animate-float" 
                style={{ animation: 'float 8s ease-in-out infinite 1s' }}
              >
                <img 
                  src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80&blend=4285F4&blend-alpha=5&blend-mode=normal&blend-saturation=50"
                  alt="AI learning" 
